...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    { 
        ...
        setError("Password incorrect. Failed to login. Please try again.'");
      }
  ...
  return (
    ...
    />
            ...
            <Typography component="p" variant="p"> <h3>{error && <div className="alert alert-danger mt-3">{error}</div>}</h3></Typography>
          </Box>
        </Box>
      </Grid>
    </Grid>
